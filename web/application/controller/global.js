...
define(function(require) {
	return function(app) {
		app.run([ '$rootScope','Announcement', ,'$timeout', '$http','GeneratedKey','UploadFile','ProvCode',
				function($rootScope,Announcement, $timeout, $http,GeneratedKey,UploadFile,ProvCode) {
