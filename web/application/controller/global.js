...
define(function(require) {
	return function(app) {
		app.run([ '$rootScope','Announcement', 'Demand','$timeout', '$http','GeneratedKey','UploadFile','ProvCode',
				function($rootScope,Announcement,Demand, $timeout, $http,GeneratedKey,UploadFile,ProvCode) {
