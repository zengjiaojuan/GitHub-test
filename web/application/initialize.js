...
define(function (require) {
    ...
    app.run(['$rootScope' , '$location' , '$timeout' , '$http' , '$route' , function ($rootScope , $location , $timeout , $http , $route) {
        ...
        $rootScope.isHideSidebar = function () {//将不需要左侧菜单的页面列入
            return  $rootScope.path == '/at/index'
                || $rootScope.path == '/at/useraccount'
                || $rootScope.path == '/at/mobileuser'
                || $rootScope.path == '/at/userloan'
                || $rootScope.path == '/at/contract'
                || $rootScope.path == '/at/customer'
                || $rootScope.path == '/at/contractarchive'
                || $rootScope.path == '/at/borrowers'
                || $rootScope.path == '/at/creditratio'
