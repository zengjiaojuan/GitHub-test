define(function (require) {
  ...
  //订阅通知^订阅管理-->订阅日志推送状态 {{ exports | RSL_pushStats }}
    ...
    filterFactory('PHB_obligatoryright', {
        1: '两者都选 ',
        2: '电子邮件',
        3: '信件'
    });
    filterFactory('PHB_managerdep', {
        1: '北京 ',
        2: '本溪一部',
        3: '本溪二部',
        4: '张家口'
    });
    filterFactory('PHB_archived', {
        0: '否 ',
        1: '是'
    });
    filterFactory('DSL_borrowerjob', {
        1: '私营业主 ',
        2: '工薪',
        3: '企业高管'
    });
    filterFactory('DSL_borrowerwarrant', {
        1: '质贷 ' 
    });
    filterFactory('DSL_borrowerusage', {
        1: '扩大经营 ',
        2: '资金周转',
        3: '个人消费'
    });
