...
@Controller
@RequestMapping(value = "/borrowerManagement")
public class BorrowerManagementController extends BaseController<BorrowerManagement, String> {
	@Resource(name = "borrowerManagementService")
	public void setBaseService(IBaseService<BorrowerManagement, String> baseService) {
	...
	public Map<String, Object> queryDoctorsManagement(@RequestParam int pageno,@RequestParam(value="clinic_id") String clinicId){
		Pager<BorrowerManagement> pdoctorResult=new Pager<BorrowerManagement>();
		...
		Pager<BorrowerManagement> p=this.getBaseService().findByPager(pdoctorResult, hmap);
